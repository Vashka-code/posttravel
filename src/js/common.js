...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Маска
  Inputmask({ mask: "+7 (999) 999 99-99"}).mask(document.querySelector('input[name="phone"]'));
  ...
  jQuery('.contactBlock__form').submit(function(e) {
    ...
    let message = jQuery(this).find('textarea[name="message"]').val();
    let aemail = jQuery('#email').text();
